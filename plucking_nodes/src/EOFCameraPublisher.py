...
serial="243522071155"#"244222073574"
...
def main():
    ...
    color_pub = rospy.Publisher("/cameraEOF/color_image", Image, queue_size=3)
    depth_pub = rospy.Publisher("/cameraEOF/depth_image", Image, queue_size=3)
    ...
    try:
        ...
        rospy.loginfo("RealSense pipeline for eye started successfully.")
