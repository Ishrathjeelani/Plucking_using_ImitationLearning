...
# model = TransformerModel(input_dim=44, output_dim=20, input_timesteps=10, output_timesteps=5)

# trainer = pl.Trainer(logger=logger, max_epochs=20, accelerator='gpu' if torch.cuda.is_available() else 'cpu')
# trainer.fit(model, train_loader, val_loader)
# trainer.test(model, test_loader)
# # Save model weights
# trainer.save_checkpoint("proprioTrans_model.ckpt")
# print("Model weights saved as 'proprioTrans_model.ckpt'")