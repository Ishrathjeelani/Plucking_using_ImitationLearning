...
class ACTTactileModel(pl.LightningModule):
    ...
    def __init__(self,cfg, input_dim, output_dim, input_timesteps, output_timesteps, d_model=128, num_heads=8, num_layers=4, action_dim=15):
        super(ACTTactileModel, self).__init__()
        ...
        # Feature extractor for tactile images
    ...
    def forward(self, x, actions, digit_index, digit_thumb):
    ...
    def training_step(self, batch, batch_idx):
        ...
        predicted_states = self(x[:,:, input_indices],x[:,5:,action_indices], digit_index, digit_thumb)
...
def main(cfg:DictConfig):
    ...
    # Save model weights
    trainer.save_checkpoint("tactileProprioACT_model.ckpt")
    print("Model weights saved as 'tactileProprioACT_model.ckpt'")
