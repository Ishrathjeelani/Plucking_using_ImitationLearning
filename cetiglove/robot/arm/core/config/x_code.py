...
ControllerErrorCodeMap = {
    ...
    10: {
        "en": {"title": "Servo motor error", "desc": ""},
        "cn": {"title": "关节错误", "desc": ""},
    },
    11: {
        "en": {"title": "Servo motor 1 error", "desc": ""},
        "cn": {"title": "关节1错误", "desc": ""},
    },
    12: {
        "en": {"title": "Servo motor 2 error", "desc": ""},
        "cn": {"title": "关节2错误", "desc": ""},
    },
    13: {
        "en": {"title": "Servo motor 3 error", "desc": ""},
        "cn": {"title": "关节3错误", "desc": ""},
    },
    14: {
        "en": {"title": "Servo motor 4 error", "desc": ""},
        "cn": {"title": "关节4错误", "desc": ""},
    },
    15: {
        "en": {"title": "Servo motor 5 error", "desc": ""},
        "cn": {"title": "关节5错误", "desc": ""},
    },
    16: {
        "en": {"title": "Servo motor 6 error", "desc": ""},
        "cn": {"title": "关节6错误", "desc": ""},
    },
    17: {
        "en": {"title": "Servo motor 7 error", "desc": ""},
        "cn": {"title": "关节7错误", "desc": ""},
    },
    18: {
        "en": {
        ...
        "cn": {"title": "力矩传感器通信失败", "desc": "请检查力矩传感器是否安装"},
    },
    19: {
        "en": {
    ...
    21: {
        "en": {"title": "Kinematic Error", "desc": "Please re-plan the path."},
        "cn": {"title": "运动学错误", "desc": "请重新规划路径。"},
    },
    22: {
        "en": {
    ...
    25: {
        ...
        "cn": {"title": "规划错误", "desc": "请重新规划路径或者减小运动速度。"},
    },
    26: {
        "en": {"title": "Linux RT Error", "desc": "Please contact technical support."},
        "cn": {"title": "Linux RT 错误", "desc": "请联系技术支持。"},
    },
    27: {
        "en": {
    ...
    30: {
        ...
        "cn": {"title": "反馈速度超出限制", "desc": "请联系技术支持。"},
    },
    31: {
        "en": {
    ...
    39: {
        ...
        "cn": {"title": "电源板主从IC通信异常", "desc": "请联系技术支持。"},
    },
    40: {
        "en": {
        ...
        "cn": {"title": "无报错的关节轨迹求解失败", "desc": "请调整点位。"},
    },
    41: {
        "en": {
    ...
    50: {
        "en": {"title": "Six-axis Force Torque Sensor read error", "desc": ""},
        "cn": {"title": "六维力矩传感器读取数据错误", "desc": ""},
    },
    51: {
        "en": {"title": "Six-axis Force Torque Sensor set mode error", "desc": ""},
        "cn": {"title": "六维力矩传感器设置模式错误", "desc": ""},
    },
    52: {
        "en": {"title": "Six-axis Force Torque Sensor set zero error", "desc": ""},
        "cn": {"title": "六维力矩传感器设置零点错误", "desc": ""},
    },
    53: {
        "en": {
    ...
    110: {
        ...
        "cn": {"title": "机械臂底座板通信异常", "desc": "请联系技术支持。"},
    },
    111: {
        "en": {
        ...
        "cn": {"title": "控制器外接485设备通信异常", "desc": "请联系技术支持。"},
    },
    "other": {
        "en": {"title": "Other Errors", "desc": ""},
        "cn": {"title": "其他错误", "desc": ""},
    },
}
...
ControllerWarnCodeMap = {
    11: {
        "en": {"title": "Current controller cache is full", "desc": ""},
        "cn": {"title": "当前控制器缓存已满", "desc": ""},
    },
    12: {
        "en": {"title": "User instruction parameter error", "desc": ""},
        "cn": {"title": "用户指令参数错误", "desc": ""},
    },
    13: {
        "en": {"title": "User command control code does not exist", "desc": ""},
        "cn": {"title": "用户指令控制码不存在", "desc": ""},
    },
    14: {
        "en": {
        ...
        "cn": {"title": "用户指令和参数无解", "desc": ""},
    },
    15: {
        "en": {"title": "Modbus cmd full", "desc": ""},
        "cn": {"title": "Modbus指令已满", "desc": ""},
    },
    "other": {
        "en": {"title": "Other Warnings", "desc": ""},
        "cn": {"title": "其它警告", "desc": ""},
    },
}
...
RobotiqErrorCodeMap = {
    ...
    0x07: {
        ...
        "cn": {"title": "Robotiq 机械爪", "desc": "激活位必须在机械爪运动前设置"},
    },
    0x08: {
        "en": {
            "title": "Robotiq Gripper",
        ...
        "cn": {"title": "Robotiq 机械爪", "desc": "超过最高工作温度，请等待机械爪冷却"},
    },
    0x09: {
        "en": {
            "title": "Robotiq Gripper",
        ...
        "cn": {"title": "Robotiq 机械爪", "desc": "通信中断超过1秒"},
    },
    0x0A: {
        "en": {"title": "Robotiq Gripper", "desc": "Under minimum operating voltage"},
        "cn": {"title": "Robotiq 机械爪", "desc": "低于最小工作电压"},
    },
    0x0B: {
        "en": {"title": "Robotiq Gripper", "desc": "Automatic release in progress"},
        "cn": {"title": "Robotiq 机械爪", "desc": "正在自动释放"},
    },
    0x0C: {
        "en": {
            "title": "Robotiq Gripper",
    ...
    0x0E: {
        "en": {"title": "Robotiq Gripper", "desc": "Over current triggered"},
        "cn": {"title": "Robotiq 机械爪", "desc": "过流"},
    },
    0x0F: {
        "en": {"title": "Robotiq Gripper", "desc": "Automatic release completed"},
        "cn": {"title": "Robotiq 机械爪", "desc": "自动松开完成"},
    },
    "other": {
        "en": {"title": "Robotiq Gripper", "desc": "Other fault"},
        "cn": {"title": "Robotiq 机械爪", "desc": "其它故障"},
    },
}
...
BioGripperErrorCodeMap = {
    ...
    "other": {
        "en": {"title": "BIO Gripper", "desc": "Other fault"},
        "cn": {"title": "BIO 机械爪", "desc": "其它故障"},
    },
}
...
class BaseCode(object):
    ...
    @property
    def title(self):
        return {"en": self.info["en"]["title"], "cn": self.info["cn"]["title"]}

    @property
    def description(self):
        return {"en": self.info["en"]["desc"], "cn": self.info["cn"]["desc"]}
