...
class DataSaver:
    ...
    "timestamp",
    # xArm7 Joint States (7 joints: positions, velocities, and torques), end-effector forces and process stage
    ...
    def callback_state(self, msg, source):
        ...
        timestamp = datetime.now().strftime('%Y-%m-%d %H:%M:%S-%f')  # Current timestamp
    ...
    def callback_image(self, msg, camera_name):
        ...
        timestamp = datetime.now().strftime('%Y-%m-%d_%H-%M-%S-%f')  # Current timestamp for filename
    ...
    def joint_states_callback(self,msg):
        """Callback for Allegro hand data (joint states)."""
...
if __name__ == "__main__":
    try:
        ...
        csv_file = r"/home/bonggeeun/Ishrath/Experiment/Exp10x.csv"  # Path to save CSV file
        image_folder = r"/home/bonggeeun/Ishrath/Experiment/imagesExp10x"  # Folder to save images
